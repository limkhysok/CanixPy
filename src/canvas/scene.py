from PyQt6.QtWidgets import QGraphicsScene, QGraphicsRectItem, QGraphicsEllipseItem, QGraphicsTextItem, QGraphicsItem
...
class DesignScene(QGraphicsScene):
    ...
    # Add this inside the DesignScene class in src/canvas/scene.py
